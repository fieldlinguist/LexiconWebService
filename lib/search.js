...
var addQueryTokens = function(queryTokens, fuzzy, operator) {
  ...
  for (var token in queryTokens) {
    ...
    var term = {};
    term[field] = pieces[1];
    elasticsearchTemplate.highlight.fields[field] = {};
  ...
  if (!queryTokens.length) {
    delete elasticsearchTemplate.query.bool;
    elasticsearchTemplate.query.match_all = {};
  }

  debug("elasticsearchTemplate", JSON.stringify(elasticsearchTemplate.query[type]));
